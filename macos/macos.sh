...
# Trackpad: Swipe between full screen apps with three finger swipe
...
# Enable AptX and AAC codecs for bluetooth headphones
...
# Disable thumbnail for screenshots
